...
const MAW: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-4">
      ...
      {/* Flex Container for the Two MAW Cards */}
      <div className="flex gap-4">
        {/* MAW 2025 (New Batch) Card */}
        <div className="bg-white rounded-lg shadow-md p-6 w-96">
          <h2 className="text-xl font-bold mb-2">MAW - 2025 (New Batch)</h2>
          <p className="text-gray-600 text-sm mb-4">MAW - Comprehensive Preparation! (Batch Starting from 14th Sept)</p>
        ...
        {/* MAW 2025 Card */}
        <div className="bg-white rounded-lg shadow-md p-6 w-96">
          <h2 className="text-xl font-bold mb-2">MAW - 2025</h2>
          <p className="text-gray-600 text-sm mb-4">MAW - Comprehensive Preparation!</p>
